...
//var_dump($blog->posts());
//var_dump($blog->next());
//var_dump($blog->setKeyword('FTP'));
//
//var_dump($blog->labels(10));


//$blog1 = BlogReader::fromUrl('en.blog.wordpress.com');
//var_dump($blog1->getInfo());
//$fields = ['id', 'title', 'content'];
//var_dump($blog1->posts($fields, 5, 1));
//var_dump($blog1->next());
